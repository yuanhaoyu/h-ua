...
var ua = function ua(config) {
    var _ua = navigator.userAgent.toLowerCase();
    return selectFactory(_ua);
};
var enviorment = [{ n: isWechat, v: 'wechat' }, { n: isQQ, v: 'mqq' }, { n: isWeibo, v: 'weibo' }, { n: isAndroid, v: 'android' }, { n: isIOS, v: 'ios' }];
...
var _hUa = require('../src/h-ua');

var _hUa2 = _interopRequireDefault(_hUa);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log((0, _hUa2.default)());
console.log(window.HAPPY_UA());
document.querySelector('.test').innerHTML = (0, _hUa2.default)();
},{"../src/h-ua":2}],8:[function(require,module,exports) {
